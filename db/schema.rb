...
ActiveRecord::Schema.define(version: 20170129141023) do
  ...
  create_table "rating_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["rating_id"], name: "index_rating_comments_on_rating_id"
  ...
  create_table "rcomments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["rating_id"], name: "index_rcomments_on_rating_id"
  ...
  create_table "skinews", force: :cascade do |t|
    t.string   "title"
    t.text     "body"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false

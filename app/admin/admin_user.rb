ActiveAdmin.register AdminUser do
  ...
  index do
    ...
    actions defaults: false do |admin|
      links = link_to 'Zobraziť', admin_admin_user_path(admin),
                      class: 'member_link'
      links += link_to 'Upraviť', edit_admin_admin_user_path(admin),
                       class: 'member_link'
      links += link_to 'Odstrániť', admin_admin_user_path(admin),
                       method: :delete, data: { confirm: 'Ste si istí?' }, class: 'member_link'
      links
    end
  end
